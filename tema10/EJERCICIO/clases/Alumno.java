...
public class Alumno implements Comparable<Alumno> {
     ...
     * 0: si ambos alumnos son iguales (tienenla misma edad)
     * 1: A > B (el alumno A es mayor que B)
     * 
     * @param b
     * @return
     */
    ...
    public int compareTo(Alumno b){
        ...
        if (this.edad == b.edad) {resultado =0;}
        else if (this.edad < b.edad) {resultado = -1;}
        else {resultado =1;}
        return resultado;
    }
    ...
    public String toString(){
        return String.format("%s: %s %s, edad: %d", this.dni,this.nombre,this.apellido,this.edad);
    }
}
